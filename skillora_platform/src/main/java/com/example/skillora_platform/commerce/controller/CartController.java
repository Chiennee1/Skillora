...
import com.example.skillora_platform.commerce.service.CartService;
...
@RestController
@RequestMapping(Constants.CART_API_PREFIX)
...
public class CartController {
    ...
    public ResponseEntity<ApiResponse<CartResponse>> add(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success("Course added to cart", cartService.add(courseId, jwt.getSubject())));
    }
    ...
    public ResponseEntity<Void> remove(
        ...
        cartService.remove(courseId, jwt.getSubject());
